...
import type { ProductFilters } from "@/src/services/api";
  ...
  return (
    <div className="min-h-screen bg-background pb-20 px-[1rem] sm:px-[5rem] transition-colors">
      <div className="container-custom py-2 sm:py-8">
        ...
        <div className="md:hidden sticky top-[64px] z-40 bg-background/80 backdrop-blur-md -mx-4 px-4 pt-2 mb-6 border-b border-border/50">
